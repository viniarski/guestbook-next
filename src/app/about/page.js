  ...
  return (
    <div className="flex justify-center">
      <p className="max-w-5xl w-full font-mono text-white text-justify max-w-prose">
        ...
        provides a platform for users to connect and interact. Feel free to post
        your own messages and read through the posts shared by other users. Join
        us in spreading positivity, support through our guestbook. Start sharing
        your voice today!
      </p>
    </div>
  );
